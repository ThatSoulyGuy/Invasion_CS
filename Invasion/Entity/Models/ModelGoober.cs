...
namespace Invasion.Entity.Models
{
    public class ModelGoober : EntityModel
    {
        public override void Initialize()
        {
            ...
            ModelPart head = Register(ModelPart.Create("head", "goober"));
            ...
            ModelPart body = Register(ModelPart.Create("body", "goober"));
            ...
            ModelPart rightArm = Register(ModelPart.Create("right_arm", "goober"));
            ...
            ModelPart leftArm = Register(ModelPart.Create("left_arm", "goober"));
            ...
            ModelPart rightLeg = Register(ModelPart.Create("right_leg", "goober"));
            ...
            ModelPart leftLeg = Register(ModelPart.Create("left_leg", "goober"));
